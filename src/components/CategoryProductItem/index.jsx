...
export default function CategoryProduct({ title, category, id, description, price, discountPercentage, rating, thumbnail, images }) {
    ...
    return (
        <div className={s.container}>
            <Link to={link} className={s.link}>
                ...
                <img src={images[0]} alt="product_img" />
